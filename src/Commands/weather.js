...
module.exports = new Command({
    ...
    async run(message, args, client) {
        ...
        weather.find({
            ...
            embed.setAuthor(current.observationpoint)
                .setDescription(`> ${current.skytext}`)
                .setThumbnail(current.imageUrl)
                .setTimestamp()
                .setColor(`#00ff00`)

            embed.addField("Latitude", "<a:ar:878262605154766899> " + location.lat, true)
                .addField("Longitude", "<a:ar:878262605154766899> " + location.long, true)
                .addField("Feels Like", "<a:ar:878262605154766899> " + `${current.feelslike}°C`, true)
